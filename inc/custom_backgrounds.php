...
class PasseridaeMultiImageBackground extends WP_Customize_Control
{
    ...
    {
        wp_enqueue_style( 'passeridae-customizer-draggable', get_template_directory_uri() . '/css/customizer/customizer.css' );
    ...
    public function render_content()
    {
		...
		?><ul id="sortable" style="min-height:30px; width:100%; border:1px solid #000">
			<?PHP
				foreach($imgs as $img){
		...
		<a href="#" id="empty-backgrounds" class="button-secondary">
            <?php echo 'Remove all'; ?>
        </a>
		<div id="scroll"><ul><?PHP
